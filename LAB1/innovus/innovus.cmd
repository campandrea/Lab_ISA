...
#  Created on Sat Oct 31 18:55:10 2020                
#                                                     
#######################################################
...
saveDesign IIR_filter_period_min_x4.enc
getDrawView
setDrawView fplan
win
dumpToGIF ./ss_IIR_filter_period_min_x4.fplan.gif
getDrawView
setDrawView amoeba
win
dumpToGIF ./ss_IIR_filter_period_min_x4.amoeba.gif
getDrawView
setDrawView place
win
dumpToGIF ./ss_IIR_filter_period_min_x4.place.gif
checkPlace checkplace.ss.rpt
reset_parasitics
extractRC
rcOut -setload IIR_filter_period_min_x4.setload -rc_corner my_rc
rcOut -setres IIR_filter_period_min_x4.setres -rc_corner my_rc
rcOut -spf IIR_filter_period_min_x4.spf -rc_corner my_rc
rcOut -spef IIR_filter_period_min_x4.spef -rc_corner my_rc
...
read_activity_file -format VCD -scope /Tb_filter_IIR/DUT -start {} -end {} -block {} ../sim/vcd/desing_period_min_x4.vcd
set_power -reset
