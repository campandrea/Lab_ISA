...
module IIR_filter ( CLK, RST_n, DIN, VIN, a0, a1, b0, b1, DOUT, VOUT );
  ...
  DFF_X1 VIN_reg_Q_reg ( .D(VIN_reg_n4), .CK(CLK), .Q(VIN_samp), .QN(
        VIN_reg_n3) );
  NOR2_X2 reg0_U28 ( .A1(VIN_samp), .A2(n3), .ZN(reg0_n38) );
  AOI22_X1 reg0_U27 ( .A1(sum_a0[6]), .A2(reg0_n39), .B1(reg_out[6]), .B2(
        reg0_n38), .ZN(reg0_n32) );
  INV_X1 reg0_U26 ( .A(reg0_n32), .ZN(reg0_n6) );
  AOI22_X1 reg0_U25 ( .A1(sum_a0[4]), .A2(reg0_n39), .B1(reg_out[4]), .B2(
        reg0_n38), .ZN(reg0_n34) );
  INV_X1 reg0_U24 ( .A(reg0_n34), .ZN(reg0_n8) );
  AOI22_X1 reg0_U23 ( .A1(sum_a0[2]), .A2(reg0_n39), .B1(reg_out[2]), .B2(
        reg0_n38), .ZN(reg0_n36) );
  INV_X1 reg0_U22 ( .A(reg0_n36), .ZN(reg0_n10) );
  ...
  AOI22_X1 reg0_U17 ( .A1(sum_a0[5]), .A2(reg0_n39), .B1(reg_out[5]), .B2(
        reg0_n38), .ZN(reg0_n33) );
  INV_X1 reg0_U16 ( .A(reg0_n33), .ZN(reg0_n7) );
  AOI22_X1 reg0_U15 ( .A1(sum_a0[0]), .A2(reg0_n39), .B1(reg_out[0]), .B2(
        reg0_n38), .ZN(reg0_n40) );
  INV_X1 reg0_U14 ( .A(reg0_n40), .ZN(reg0_n12) );
  AOI22_X1 reg0_U13 ( .A1(sum_a0[11]), .A2(reg0_n39), .B1(reg_out[11]), .B2(
        reg0_n38), .ZN(reg0_n27) );
  INV_X1 reg0_U12 ( .A(reg0_n27), .ZN(reg0_n1) );
  AOI22_X1 reg0_U11 ( .A1(sum_a0[9]), .A2(reg0_n39), .B1(reg_out[9]), .B2(
        reg0_n38), .ZN(reg0_n29) );
  INV_X1 reg0_U10 ( .A(reg0_n29), .ZN(reg0_n3) );
  AOI22_X1 reg0_U9 ( .A1(sum_a0[7]), .A2(reg0_n39), .B1(reg_out[7]), .B2(
        reg0_n38), .ZN(reg0_n31) );
  INV_X1 reg0_U8 ( .A(reg0_n31), .ZN(reg0_n5) );
  AOI22_X1 reg0_U7 ( .A1(sum_a0[10]), .A2(reg0_n39), .B1(reg_out[10]), .B2(
        reg0_n38), .ZN(reg0_n28) );
  INV_X1 reg0_U6 ( .A(reg0_n28), .ZN(reg0_n2) );
  AOI22_X1 reg0_U5 ( .A1(sum_a0[8]), .A2(reg0_n39), .B1(reg_out[8]), .B2(
        reg0_n38), .ZN(reg0_n30) );
  INV_X1 reg0_U4 ( .A(reg0_n30), .ZN(reg0_n4) );
  ...
  INV_X1 mult_b0_mult_15_U343 ( .A(mult_b0_mult_15_n514), .ZN(
        mult_b0_mult_15_n426) );
  INV_X1 mult_b0_mult_15_U342 ( .A(mult_b0_mult_15_n523), .ZN(
        mult_b0_mult_15_n421) );
  INV_X1 mult_b0_mult_15_U341 ( .A(sum_a0[0]), .ZN(mult_b0_mult_15_n440) );
  INV_X1 mult_b0_mult_15_U340 ( .A(mult_b0_mult_15_n31), .ZN(
        mult_b0_mult_15_n420) );
  INV_X1 mult_b0_mult_15_U339 ( .A(mult_b0_mult_15_n41), .ZN(
        mult_b0_mult_15_n425) );
  INV_X1 mult_b0_mult_15_U338 ( .A(mult_b0_mult_15_n73), .ZN(
        mult_b0_mult_15_n435) );
  AND3_X1 mult_b0_mult_15_U337 ( .A1(mult_b0_mult_15_n533), .A2(
        mult_b0_mult_15_n441), .A3(sum_a0[1]), .ZN(mult_b0_mult_15_n416) );
  AND2_X1 mult_b0_mult_15_U336 ( .A1(mult_b0_mult_15_n531), .A2(
        mult_b0_mult_15_n533), .ZN(mult_b0_mult_15_n415) );
  MUX2_X1 mult_b0_mult_15_U335 ( .A(mult_b0_mult_15_n415), .B(
        mult_b0_mult_15_n416), .S(mult_b0_mult_15_n442), .Z(
        mult_b0_mult_15_n414) );
  INV_X1 mult_b0_mult_15_U334 ( .A(mult_b0_mult_15_n503), .ZN(
        mult_b0_mult_15_n431) );
  INV_X1 mult_b0_mult_15_U333 ( .A(mult_b0_mult_15_n483), .ZN(
        mult_b0_mult_15_n439) );
  INV_X1 mult_b0_mult_15_U332 ( .A(sum_a0[11]), .ZN(mult_b0_mult_15_n419) );
  INV_X1 mult_b0_mult_15_U331 ( .A(sum_a0[9]), .ZN(mult_b0_mult_15_n422) );
  INV_X1 mult_b0_mult_15_U330 ( .A(sum_a0[7]), .ZN(mult_b0_mult_15_n427) );
  INV_X1 mult_b0_mult_15_U329 ( .A(sum_a0[5]), .ZN(mult_b0_mult_15_n432) );
  INV_X1 mult_b0_mult_15_U328 ( .A(sum_a0[3]), .ZN(mult_b0_mult_15_n437) );
  INV_X1 mult_b0_mult_15_U327 ( .A(mult_b0_mult_15_n494), .ZN(
        mult_b0_mult_15_n436) );
  INV_X1 mult_b0_mult_15_U326 ( .A(mult_b0_mult_15_n528), .ZN(
        mult_b0_mult_15_n434) );
  INV_X1 mult_b0_mult_15_U325 ( .A(mult_b0_mult_15_n527), .ZN(
  ...
  INV_X1 mult_b1_mult_15_U342 ( .A(b1[1]), .ZN(mult_b1_mult_15_n440) );
  ...
  INV_X1 mult_b1_mult_15_U336 ( .A(mult_b1_mult_15_n493), .ZN(
        mult_b1_mult_15_n435) );
  INV_X1 mult_b1_mult_15_U335 ( .A(mult_b1_mult_15_n513), .ZN(
        mult_b1_mult_15_n427) );
  INV_X1 mult_b1_mult_15_U334 ( .A(mult_b1_mult_15_n522), .ZN(
        mult_b1_mult_15_n423) );
  INV_X1 mult_b1_mult_15_U333 ( .A(mult_b1_mult_15_n502), .ZN(
        mult_b1_mult_15_n431) );
  INV_X1 mult_b1_mult_15_U332 ( .A(mult_b1_mult_15_n31), .ZN(
        mult_b1_mult_15_n422) );
  INV_X1 mult_b1_mult_15_U331 ( .A(mult_b1_mult_15_n41), .ZN(
  ...
  BUF_X1 mult_b1_mult_15_U328 ( .A(n2), .Z(mult_b1_mult_15_n414) );
  INV_X1 mult_b1_mult_15_U327 ( .A(mult_b1_mult_15_n530), .ZN(
        mult_b1_mult_15_n437) );
  INV_X1 mult_b1_mult_15_U326 ( .A(mult_b1_mult_15_n532), .ZN(
        mult_b1_mult_15_n436) );
  INV_X1 mult_b1_mult_15_U325 ( .A(mult_b1_mult_15_n527), .ZN(
  ...
  INV_X1 mult_a0_mult_15_U348 ( .A(reg_out[11]), .ZN(mult_a0_mult_15_n424) );
  INV_X1 mult_a0_mult_15_U347 ( .A(reg_out[9]), .ZN(mult_a0_mult_15_n422) );
  INV_X1 mult_a0_mult_15_U346 ( .A(a1[1]), .ZN(mult_a0_mult_15_n445) );
  ...
  INV_X1 mult_a0_mult_15_U340 ( .A(mult_a0_mult_15_n498), .ZN(
        mult_a0_mult_15_n440) );
  INV_X1 mult_a0_mult_15_U339 ( .A(mult_a0_mult_15_n73), .ZN(
        mult_a0_mult_15_n439) );
  INV_X1 mult_a0_mult_15_U338 ( .A(mult_a0_mult_15_n527), .ZN(
        mult_a0_mult_15_n428) );
  INV_X1 mult_a0_mult_15_U337 ( .A(mult_a0_mult_15_n507), .ZN(
        mult_a0_mult_15_n436) );
  INV_X1 mult_a0_mult_15_U336 ( .A(mult_a0_mult_15_n31), .ZN(
        mult_a0_mult_15_n427) );
  INV_X1 mult_a0_mult_15_U335 ( .A(mult_a0_mult_15_n41), .ZN(
        mult_a0_mult_15_n431) );
  INV_X1 mult_a0_mult_15_U334 ( .A(mult_a0_mult_15_n424), .ZN(
        mult_a0_mult_15_n423) );
  INV_X1 mult_a0_mult_15_U333 ( .A(mult_a0_mult_15_n422), .ZN(
        mult_a0_mult_15_n421) );
  INV_X1 mult_a0_mult_15_U332 ( .A(mult_a0_mult_15_n487), .ZN(
        mult_a0_mult_15_n443) );
  BUF_X1 mult_a0_mult_15_U331 ( .A(n2), .Z(mult_a0_mult_15_n414) );
  INV_X1 mult_a0_mult_15_U330 ( .A(mult_a0_mult_15_n535), .ZN(
        mult_a0_mult_15_n442) );
  INV_X1 mult_a0_mult_15_U329 ( .A(mult_a0_mult_15_n416), .ZN(
        mult_a0_mult_15_n415) );
  INV_X1 mult_a0_mult_15_U328 ( .A(mult_a0_mult_15_n420), .ZN(
        mult_a0_mult_15_n419) );
  INV_X1 mult_a0_mult_15_U327 ( .A(mult_a0_mult_15_n418), .ZN(
        mult_a0_mult_15_n417) );
  INV_X1 mult_a0_mult_15_U326 ( .A(mult_a0_mult_15_n537), .ZN(
        mult_a0_mult_15_n441) );
  INV_X1 mult_a0_mult_15_U325 ( .A(mult_a0_mult_15_n532), .ZN(
        mult_a0_mult_15_n438) );
  INV_X1 mult_a0_mult_15_U324 ( .A(mult_a0_mult_15_n531), .ZN(
  ...
  INV_X1 mult_a0_mult_15_U321 ( .A(mult_a0_mult_15_n55), .ZN(
        mult_a0_mult_15_n435) );
  INV_X1 mult_a0_mult_15_U320 ( .A(mult_a0_mult_15_n112), .ZN(
        mult_a0_mult_15_n429) );
  INV_X1 mult_a0_mult_15_U319 ( .A(mult_a0_mult_15_n117), .ZN(
