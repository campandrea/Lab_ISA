...
# Created by write_sdc on Mon Oct 26 12:07:05 2020
...
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[9]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[8]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[7]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[6]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[5]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[4]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[3]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[2]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[1]}]
set_input_delay -clock CLK  -max 0.5  [get_ports {a0[0]}]
