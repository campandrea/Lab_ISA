...
# Created by write_sdc on Sun Nov  8 20:58:00 2020

###################################################################
set sdc_version 2.1

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current mA
create_clock [get_ports CLK]  -name MY_CLK  -period 8.6  -waveform {0 4.3}
...
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a0[9]}]
