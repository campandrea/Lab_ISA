...
entity Mult_Dadda2 is
generic(N : natural := 2);
port(x : in std_logic_vector(N - 1 downto 0);
y: in std_logic_vector(N - 1 downto 0);
z : out std_logic_vector(2*N - 1 downto 0));
end entity Mult_Dadda2;
architecture arch of Mult_Dadda2 is
...
subtype s_t is std_logic_vector(8 downto 0);
signal S : s_t;
subtype cout_t is std_logic_vector(8 downto 0);
signal Cout : cout_t;
...
FA1 : full_adder port map('1', n_neg(0), P(1)(1), S(1), Cout(1));
HA2 : half_adder port map('1', P(1)(2), S(2), Cout(2));
HA3 : half_adder port map(P(0)(0), neg(0), S(3), Cout(3));
HA4 : half_adder port map(P(0)(1), Cout(3), S(4), Cout(4));
FA2 : full_adder port map(neg(1), S(0), Cout(4), S(5), Cout(5));
FA3 : full_adder port map(Cout(0), S(1), Cout(5), S(6), Cout(6));
FA4 : full_adder port map(Cout(1), S(2), Cout(6), S(7), Cout(7));
HA5 : half_adder port map(Cout(2), Cout(7), S(8), Cout(8));
